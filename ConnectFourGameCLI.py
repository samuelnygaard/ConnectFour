...
class ConnectFourGame:
    ...
    def print_players_total_turn_time(self, verbose=True) -> str:
        ...
        player_total_turn_time_msg += f"{self.player_2.name} has used {round(sum(self.player_2.time_per_move), 2)} seconds in total" + "\n"
...
if __name__ == '__main__':
    # Initialize the game
    game = ConnectFourGame(human_friendly_board=True)
